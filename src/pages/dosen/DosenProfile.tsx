  ...
  return (
    <DashboardLayout userRole="dosen">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">DosenProfile</h1>
          <p className="text-gray-600">Dosen feature for DosenProfile</p>
        </div>

        <div className="bg-dosen-50 border border-dosen-200 rounded-lg p-6">
          <div className="text-center">
            <div className="text-4xl mb-4">Ì±©‚ÄçÌø´</div>
            <h2 className="text-lg font-semibold text-dosen-800 mb-2">
              DosenProfile Implementation Needed
            </h2>
